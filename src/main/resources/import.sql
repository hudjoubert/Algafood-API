...
insert into restaurant (id, name, tax_shipping, kitchen) values (1, 'Thai Gourmet', 10, 1);
insert into restaurant (id, name, tax_shipping, kitchen) values (2, 'Thai Delivery', 9.50, 1);
insert into restaurant (id, name, tax_shipping, kitchen) values (3, 'Tuk Tuk Comida Indiana', 15, 2);
